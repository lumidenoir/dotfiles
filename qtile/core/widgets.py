...
w_wlan = (
    (
        ...
        widget.Wlan(
            ...
            update_interval=5,
            mouse_callbacks={
                "Button3": lambda: qtile.cmd_spawn("kitty" + " -e nmtui"),
            },
            padding=8,
            decorations=_right_decor(),
        ),
...
def w_updates():
    ...
    return (
        widget.CheckUpdates(
            ...
            distro="Arch",
            initial_text="󰮯",
            no_update_string="󰮯",  # "󰧵",
            font="Material Design Icons",
            fontsize=18,
            foreground=color["yellow"],  # blue
            colour_have_updates=color["yellow"],  # blue
            colour_no_updates=color["yellow"],  # blue
            padding=10,
            decorations=_left_decor(w_color),
            update_interval=60,
        ),
