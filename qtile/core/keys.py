...
shift = "shift"
alt = "mod1"
# terminal = "kitty --config /home/krishna/.config/kitty/kanagawa.conf"
...
keys = [
    ...
    Key(
        [mod],
        "Return",
        lazy.spawn("kitty --config /home/krishna/.config/kitty/kanagawa.conf"),
    ...
    Key([mod], "Print", lazy.spawn("flameshot screen"), desc="screenshot screen"),
    # audio stuff
    Key(
        [],
        "XF86AudioRaiseVolume",
        lazy.spawn(home + "/.config/scripts/settings_control.sh volume_up"),
        desc="Increase volume",
    ),
    Key(
        [],
        "XF86AudioLowerVolume",
        lazy.spawn(home + "/.config/scripts/settings_control.sh volume_down"),
        desc="Decrease volume",
    ),
    Key(
        [],
        "XF86AudioMute",
        lazy.spawn(home + "/.config/scripts/settings_control.sh volume_mute"),
    ...
    Key(
        [],
        "XF86MonBrightnessUp",
        lazy.spawn(home + "/.config/scripts/settings_control.sh brightness_up"),
        desc="Increase brightness",
    ),
    Key(
        [],
        "XF86MonBrightnessDown",
        lazy.spawn(home + "/.config/scripts/settings_control.sh brightness_down"),
    ...
    KeyChord(
        ...
        [
            Key(
                [],
                "c",
                lazy.spawn("/home/krishna/dotfiles/rofi/scripts/college-search"),
                desc="Launch VSCode",
            ),
            ...
            Key(
                [],
                "w",
                lazy.spawn("/home/krishna/dotfiles/rofi/scripts/web-search.sh"),
                desc="Launch websearch",
            ),
            Key(
                [],
                "b",
                lazy.spawn("/home/krishna/dotfiles/rofi/scripts/book-search"),
