...
theme=$(printf '%s\n' "${all_themes[@]}" | rofi -dmenu -p "Select wallpaper theme: " -lines 10 -no-custom -theme ~/dotfiles/themes/onedark/onedark.rasi)
...
rofi_command="rofi -dmenu -theme ${HOME}/dotfiles/themes/WallSelect.rasi -theme-str ${rofi_override}"
