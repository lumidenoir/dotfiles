...
static const char *light_up[] = {"brightnessctl", "s", "+2000", NULL};
static const char *light_down[] = {"brightnessctl", "s", "2000-", NULL};
...
static const char* eww[] = { "rofi", "-show" , "powermenu", NULL };/*"eww", "open" , "eww"*/
...
static const Key keys[] = {
    ...
    { MODKEY,                           XK_space,       spawn,          SHCMD("rofi -show drun -config ~/.config/rofi/tokyonight.rasi") },
    { MODKEY,                           XK_Return,      spawn,          SHCMD("kitty --config ~/.config/kitty/tokyonight.conf")},
    ...
    // kill dwm
    { Mod1Mask|ControlMask,               XK_q,       spawn,        SHCMD("killall bar.sh dwm") },
    ...
    //powermenu
    { MODKEY,                 XK_p,       spawn,           SHCMD("rofi -show powermenu -config ~/.config/rofi/tokyonight.rasi")},
