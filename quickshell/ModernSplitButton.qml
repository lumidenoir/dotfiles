...
Item {
    ...
    Rectangle {
        ...
        Behavior on color { ColorAnimation { duration: mbtn.batteryMode ? 0 : 150 } }
    }
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            Behavior on scale { NumberAnimation { duration: mbtn.batteryMode ? 0 : 150 } }
            Behavior on color { ColorAnimation { duration: mbtn.batteryMode ? 0 : 150 } }
        }
    ...
    Behavior on scale { NumberAnimation { duration: mbtn.batteryMode ? 0 : 150; easing.type: Easing.OutBack } }
}
