...
(setq doom-font (font-spec :family "Iosevka" :size 15 :weight 'regular :slant 'normal :width 'expanded :spacing 90)
      ...
      doom-serif-font (font-spec :family "IosevkaTermSlab Nerd Font" :size 15 :weight 'light)
      doom-theme 'doom-one
...
** Studio Tech
#+begin_src emacs-lisp :tangle no
(setq doom-font (font-spec :family "Lilex Nerd Font Mono" :size 15 :weight 'medium :slant 'normal)
      doom-big-font-mode (font-spec :family "Lilex Nerd Font" :size 25)
...
(dolist (face '((org-level-1 . 1.4)
                ...
                (org-level-7 . 1.1)
                (org-level-8 . 1.1)))
  (set-face-attribute (car face) nil :font "IBM Plex Sans" :weight 'bold :height (cdr face)))

;; Make the document title a bit bigger
  (set-face-attribute 'org-document-title nil :font "IBM Plex Sans" :weight 'bold :height 1.8))
#+end_src

** recursive
#+begin_src emacs-lisp :tangle no
(setq doom-font (font-spec :family "Recursive Monospace" :size 15 :weight 'regular :slant 'normal)
      doom-big-font-mode (font-spec :family "Recursive Monospace" :size 25)
      doom-variable-pitch-font (font-spec :family "Recursive" :size 15)
      doom-emoji-font (font-spec :family "Noto Color Emoji")
      doom-symbol-font (font-spec :family "Iosevka")
      doom-serif-font (font-spec :family "Space Grotesk" :size 15 :weight 'light)
      doom-theme 'doom-one
      display-line-numbers-type nil)
...
(dolist (face '((org-level-1 . 1.4)
                ...
                (org-level-7 . 1.1)
                (org-level-8 . 1.1)))
  (set-face-attribute (car face) nil :font "Space Grotesk" :weight 'bold :height (cdr face)))

;; Make the document title a bit bigger
  (set-face-attribute 'org-document-title nil :font "Space Grotesk" :weight 'bold :height 1.8))
#+end_src

** Neutral Architect
#+begin_src emacs-lisp :tangle no
(setq doom-font (font-spec :family "CommitMono" :size 15 :weight 'regular :slant 'normal)
      doom-big-font-mode (font-spec :family "CommitMono" :size 25)
      doom-variable-pitch-font (font-spec :family "Inter 28pt" :size 16)
      doom-emoji-font (font-spec :family "Noto Color Emoji")
      doom-symbol-font (font-spec :family "Iosevka")
      doom-serif-font (font-spec :family "Inter 28pt" :size 15 :weight 'light)
      doom-theme 'doom-one
      display-line-numbers-type nil)
...
(dolist (face '((org-level-1 . 1.4)
                ...
                (org-level-7 . 1.1)
                (org-level-8 . 1.1)))
  (set-face-attribute (car face) nil :font "Inter 28pt" :weight 'bold :height (cdr face)))

;; Make the document title a bit bigger
  (set-face-attribute 'org-document-title nil :font "Inter 28pt" :weight 'bold :height 1.8))
#+end_src

** Rounded Modernist
#+begin_src emacs-lisp :tangle no
(setq doom-font (font-spec :family "Maple Mono" :size 15 :weight 'regular :slant 'normal)
      doom-big-font-mode (font-spec :family "Maple Mono" :size 25)
      doom-variable-pitch-font (font-spec :family "Satoshi" :size 16)
      doom-emoji-font (font-spec :family "Noto Color Emoji")
      doom-symbol-font (font-spec :family "Iosevka")
      doom-serif-font (font-spec :family "IosevkaTermSlab Nerd Font" :size 15 :weight 'light)
      doom-theme 'doom-one
...
(dolist (face '((org-level-1 . 1.4)
                ...
                (org-level-7 . 1.1)
                (org-level-8 . 1.1)))
  (set-face-attribute (car face) nil :font "Satoshi" :weight 'semibold :height (cdr face)))

;; Make the document title a bit bigger
  (set-face-attribute 'org-document-title nil :font "Bricolage Grotesque" :weight 'semibold :height 1.8))
#+end_src

** Quiet minimalist
#+begin_src emacs-lisp :tangle no
(setq doom-font (font-spec :family "CommitMono" :size 15 :weight 'regular :slant 'normal)
      doom-big-font-mode (font-spec :family "Commit Mono" :size 25)
      doom-variable-pitch-font (font-spec :family "Recursive" :size 16)
      doom-emoji-font (font-spec :family "Noto Color Emoji")
      doom-symbol-font (font-spec :family "Iosevka")
      doom-serif-font (font-spec :family "IBM Plex Serif" :size 15 :weight 'light)
      doom-theme 'doom-one
      display-line-numbers-type nil)
...
(dolist (face '((org-level-1 . 1.4)
                ...
                (org-level-7 . 1.1)
                (org-level-8 . 1.1)))
  (set-face-attribute (car face) nil :font "IBM Plex Serif" :weight 'semibold :height (cdr face)))

;; Make the document title a bit bigger
  (set-face-attribute 'org-document-title nil :font "IBM Plex Serif" :weight 'bold :height 1.8))
#+end_src

** Monaspace
#+begin_src emacs-lisp :tangle no
(setq doom-font (font-spec :family "Monaspace Radon" :size 15 :weight 'regular :slant 'normal)
      doom-big-font-mode (font-spec :family "Monaspace Radon" :size 25)
      doom-variable-pitch-font (font-spec :family "Iosevka Charon" :size 16)
      doom-emoji-font (font-spec :family "Noto Color Emoji")
      doom-symbol-font (font-spec :family "Iosevka")
      doom-serif-font (font-spec :family "Monaspace Xenon" :size 15 :weight 'light)
      doom-theme 'doom-one
      display-line-numbers-type nil)
...
(dolist (face '((org-level-1 . 1.4)
                ...
                (org-level-7 . 1.1)
                (org-level-8 . 1.1)))
  (set-face-attribute (car face) nil :font "Iosevka Charon" :weight 'semibold :height (cdr face)))

;; Make the document title a bit bigger
  (set-face-attribute 'org-document-title nil :font "Iosevka Charon" :weight 'bold :height 1.8))
#+end_src
** Sharp Functionalist
#+begin_src emacs-lisp :tangle no
(setq doom-font (font-spec :family "Ioskeley Mono" :size 15 :weight 'regular :slant 'normal)
      doom-big-font-mode (font-spec :family "Ioskeley Mono" :size 25)
      doom-variable-pitch-font (font-spec :family "Iosevka Charon" :size 16)
      doom-emoji-font (font-spec :family "Noto Color Emoji")
      doom-symbol-font (font-spec :family "Iosevka")
      doom-serif-font (font-spec :family "GeistMono Nerd Font" :size 15 :weight 'light)
      doom-theme 'doom-one
      display-line-numbers-type nil)
...
(dolist (face '((org-level-1 . 1.4)
                ...
                (org-level-7 . 1.1)
                (org-level-8 . 1.1)))
  (set-face-attribute (car face) nil :font "Geist" :weight 'semibold :height (cdr face)))

;; Make the document title a bit bigger
  (set-face-attribute 'org-document-title nil :font "Geist" :weight 'bold :height 1.8))
#+end_src
** Highway
#+begin_src emacs-lisp :tangle no
(setq doom-font (font-spec :family "FiraCode Nerd Font" :size 15 :weight 'regular :slant 'normal)
      doom-big-font-mode (font-spec :family "FiraCode Nerd Font" :size 25)
      doom-variable-pitch-font (font-spec :family "Overpass Nerd Font" :size 16)
      doom-emoji-font (font-spec :family "Noto Color Emoji")
      doom-symbol-font (font-spec :family "JuliaMono Nerd Font")
      doom-serif-font (font-spec :family "IBM Plex Mono" :size 15 :weight 'light)
      doom-theme 'doom-one
      display-line-numbers-type nil)
...
** JBM
#+begin_src emacs-lisp :tangle yes
(setq doom-font (font-spec :family "JetBrains Mono" :size 15 :weight 'regular :slant 'normal)
      doom-big-font-mode (font-spec :family "JetBrains Mono" :size 25)
      doom-variable-pitch-font (font-spec :family "Inter 28pt" :size 16)
      doom-emoji-font (font-spec :family "Noto Color Emoji")
      doom-symbol-font (font-spec :family "JuliaMono Nerd Font")
      doom-serif-font (font-spec :family "JetBrains Mono" :size 15 :weight 'light)
      doom-theme 'doom-one
      display-line-numbers-type nil)
...
(after! org
  ...
  (add-hook 'org-src-mode-hook #'lsp-deferred))
...
(defun lumi/cf-sync-tags-in-buffer ()
  ...
  (let* ((filename (buffer-file-name))
    ...
    ;; Guard: must look like a real filetags string
    (when (and tags
               (not (string-empty-p tags))
               (string-prefix-p ":" tags)
               (string-suffix-p ":" tags))
      (save-excursion
        (goto-char (point-min))
              ...
              (when-let* ((marker org-capture-last-stored-marker)
                ...
                (when (string-match-p "cf_" (file-name-nondirectory file))
                  (let ((buf (or (get-file-buffer file)
                    ...
                    ;; Only kill if WE opened it (wasn't already visiting)
