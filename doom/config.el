...
(after! org
  ...
  (custom-set-faces!
    ...
    ;; Customize org-example
    ;; `((org-block-begin-line)
    ;;   :background ,(doom-darken 'grey 0.1) :foreground ,(doom-darken 'fg 0.2) :extend t :italic t)
    ;; Customize org-verse
    `((org-verse)
...
(setq todoist-token "9233ce41bf9c1eb4a8b65ee0d3b9f99721a539b6"
...
(setq wakatime-api-key ""
      wakatime-cli-path "/home/krishna/.wakatime/wakatime-cli")
...
(defun update-readme-changelog ()
  "Update README.org with latest git commits under Changelog heading."
  (interactive)
  (let ((readme-file (expand-file-name "README.org" (projectile-project-root)))
...
(map! :leader
      :desc "Update Changelog in README"
      "p u" #'update-readme-changelog)
