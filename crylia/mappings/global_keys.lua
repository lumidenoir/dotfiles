  ...
  awful.key(
    ...
    function(c)
      ...
      awful.spawn.easy_async_with_shell(
        ...
        function(stdout)
          awful.spawn.easy_async_with_shell("brightnessctl set " .. tostring(tonumber(stdout) + 5*BACKLIGHT_SEPS), function(stdou2)
  ...
  awful.key(
    ...
    function(c)
      awful.spawn.easy_async_with_shell(
        "cat /sys/class/backlight/*/brightness",
        function(stdout)
          awful.spawn.easy_async_with_shell("brightnessctl s " .. tostring(tonumber(stdout) - 5*BACKLIGHT_SEPS), function(stdout2)
