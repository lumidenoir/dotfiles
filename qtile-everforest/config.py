...
keys = [
    ...
    Key(
        [mod, mod1],
        "l",
        lazy.spawn("/home/krishna/.config/scripts/xlock.sh"),
    ...
    Key(
        [mod],
        "s",
        lazy.spawn("/home/krishna/.config/rofi/scripts/book-search"),
        desc="book-search",
    ),
    Key(
        [mod, "shift"],
        "s",
        lazy.spawn("/home/krishna/.config/rofi/scripts/college-search"),
        desc="college-search",
    ),
]
